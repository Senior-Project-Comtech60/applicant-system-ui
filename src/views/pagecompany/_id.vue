<template>
  <div>
    <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-5">
            <p>
              {{
                $i18n.locale === "th"
                  ? $route.params.company.options.province.provinceTh
                  : $route.params.company.options.province.provinceEn
              }}
            </p>
          </div>
          <div class="col-7 ">
      ...
      <div class="" v-html="`${$route.params.company.options.content}`"></div>
      <div>
